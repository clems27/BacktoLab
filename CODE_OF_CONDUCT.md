...
2. Expected Behavior:
-Be respectful and inclusive to all contributors, regardless of skill level, background, or identity.
-Communicate openly, listen actively, and provide constructive feedback.
...
-Ignoring project guidelines and best practices.

4. Collaboration Guidelines:
-Follow GitHub best practices when creating issues, making pull requests, or commenting.
-Keep commit messages clear and informative.
-Resolve conflicts professionally and seek help when needed.
...
7. Attribution:
This Code of Conduct is adapted from the Contributor Covenant (https://www.contributor-covenant.org/) and other open-source community guidelines.
